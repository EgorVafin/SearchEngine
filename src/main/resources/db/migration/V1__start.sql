...
alter table lemma_index add constraint FKcg6g2on92fqq58w5t0m6271qp foreign key (lemma_id) references lemma (id);
alter table lemma_index add constraint FKabycx15lbdehrjax4x0o53vt7 foreign key (page_id) references page (id);
alter table page add constraint FKj2jx0gqa4h7wg8ls0k3y221h2 foreign key (site_id) references site (id);
